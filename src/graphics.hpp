...
struct Graphics
{
    vector<vector<int>> keyboard_order_lower = {
        {KEY_1, KEY_2, KEY_3, KEY_4, KEY_5, KEY_6, KEY_7,
            KEY_8, KEY_9, KEY_0, KEY_DASH, KEY_EQUAL, KEY_DEL},
    ...
    vector<vector<int>> keyboard_order_upper = {
        {KEY_EXCLAMATION, KEY_AT, KEY_POUND, KEY_DOLLAR,
            ...
            KEY_BRACKET_L, KEY_BRACKET_R, KEY_UNDERSCORE, KEY_PLUS, KEY_DEL},
        ...
        {KEY_Z, KEY_X, KEY_C, KEY_V, KEY_B,
            KEY_N, KEY_M, KEY_LESS, KEY_GREAT,
    ...
    void text_mvadd_str(const int& y, const int& x, const string& str, const string& c, const bool clear_prev=false, const bool& refresh=false);
    
    void text_add_ch(const char& ch, const string& c, const bool clear_prev=false, const bool& refresh=false);
    
    /*--------------------*/
    // write msg
    void info_add_str(const string& str, const string& c, const bool& clear_prev=false, const bool& refresh = true, const string& sep="");
    
    void info_mvadd_str(const int& y, const int& x, const string& str, const string& c, const bool& clear_prev=false, const bool& refresh=true);
    
    void info_add_ch(const char& ch, const string& c, const bool& clear_prev=false, const bool& refresh=true);
    
    void info_mvadd_ch(const int& y, const int& x, const char& ch, const string& c, const bool& clear_prev=false, const bool& refresh=true);
    ...
    vector<string> preGame_menu_options{
        "Next",
        "History",
        "Quit",
        "Help"
    };
    vector<string> postGame_menu_options{
        "Restart",
        "Next",
        "History",
        "Quit",
    ...
    vector<string> inGame_menu_options{
        "Restart",
        "Next",
        "Quit"
    };
    vector<string> inHistory_menu_options{
        "Return",
        "Quit"
    };
    vector<string> inReplay_menu_options{
        "SkipToEnd",
        "Quit"
    };
    vector<string> inHelp_menu_options{
        "Return",
        "Quit"
    };
    ...
    /*--------------------*/
    // replay utilites
    void draw_keyboard(const int& y, const int& x, const int& key, const string& c);
    
    void mvclrtobot(const string& win, const int& y, const int& x, const bool& refresh=false);
