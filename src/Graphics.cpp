...
void Graphics::init_colors()
{
    ...
    colors = {
        ...
        {"white", COLOR_PAIR(7)},
        {"white-blue", COLOR_PAIR(8)},
        {"white-red", COLOR_PAIR(9)},
        {"black-green", COLOR_PAIR(10)},
        {"white cursor", COLOR_PAIR(11)},
        {"yellow cursor", COLOR_PAIR(12)},
        {"black-yellow", COLOR_PAIR(12)},
        {"yellow-magenta", COLOR_PAIR(13)},
        {"yellow-blue", COLOR_PAIR(14)},
        {"magenta-yellow", COLOR_PAIR(15)},
...
void Graphics::init_size_params(const int& user_defined_w, const int& user_defined_h)
{
    ...
    else if(user_defined_w != 0 and user_defined_h != 0)
    {
                ...
                or user_defined_h > actual_term_h)
        {
            Exit(1,
                 "Please resize Terminal window to\n"
                 + to_string(user_defined_w) + "x" + to_string(user_defined_h)
                 + " or larger.");
        }
        else
        {
...
void Graphics::draw_keyboard(const int& y, const int& x, const int& key, const string& c)
{
